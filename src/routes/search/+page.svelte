...
<div class="search_page">
  ...
  <div class="header">
    <div class="location_group">
      ...
      <div class="btn" on:keypress on:click={() => console.log("click")}>
      ...
      <div class="btn search" on:keypress on:click={() => console.log("click")}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24">
          <path
